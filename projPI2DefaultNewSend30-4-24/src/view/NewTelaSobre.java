 ...
 * @author Inacio
 */
public class NewTelaSobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(482, 294));
        ...
        jLabel1.setText("Sistema para controle de Estoque de Materiais de Construção");
        ...
        jpnSobre.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, -1, -1));
        ...
        lblTitleCadastro.setText("<html><font size = 6><b><u>Sobre</b></u></font></html>");
        lblTitleCadastro.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        jpnSobre.add(lblTitleCadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 10, 270, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewTelaSobre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewTelaSobre().setVisible(true);
            }
        });
    }
